...
Sejam \\( d \\) uma reta no plano e \\( F \\) um ponto não pertencente a \\( d \\). A parábola \\( \rho \\) de diretriz \\( d \\) e foco \\( F \\) é o conjunto que consiste em todos os pontos \\( P \\) do plano, equidistantes do ponto \\( F \\) e da reta \\( d \\), isto é,

\\[
\rho = \\{P; d(P, F) = d(P, d_{\text{reta}})\\}
\\]
...
\\( P = (x, y) \in \rho \Longleftrightarrow d(P, F) = d(P, d) \\). A reta que passa pelo ponto \\( P = (x, y) \\) e é perpendicular a reta diretriz \\( d \\) intersecta \\( d \\) no ponto \\( P = (x, -a) \\), consequentemente,
...
\\[
P = (x, y) \in \rho \Longleftrightarrow x^{2} = 4ay
\\]
...
\\( P = (x, y) \in \rho \Longleftrightarrow d(P, F) = d(P, d) \\). A reta que passa por \\( P = (x, y) \\) e é perpendicular a reta diretriz \\( d \\) intersecta \\( d \\) no ponto \\( P = (-a, y) \\), consequentemente,
